...
import com.akpdev.movies.databinding.FragmentUpcomingMovieListBinding
...
class UpcomingMovieListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvMovie.addOnScrollListener(this@UpcomingMovieListFragment.scrollListener)
